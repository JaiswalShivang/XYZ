        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Making government schemes accessible to everyone through technology and innovation. 
              Discover, apply, and track your applications with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/schemes" className="text-gray-400 hover:text-white transition duration-200">
                  Browse Schemes
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/feedback" className="text-gray-400 hover:text-white transition duration-200">
                  Feedback
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              <p>&copy; 2024 GovScheme. All rights reserved.</p>
            </div>
